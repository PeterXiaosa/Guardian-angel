...
/**
 * https://github.com/xingliuhua/XLHRatingBar/blob/master/app/src/main/java/com/xingliuhua/example/xlhratingbar/MainActivity.java
 */

public class CustomRatingBar extends LinearLayout {
    private int mNumStars = 5;// 共有几个星星
    private float mRating;
    private String mRatingViewClassName = "com.peter.guardianangel.view.starRatingBar.SimpleRatingView";
    ...
    private void initData(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mNumStars = typedArray.getInt(R.styleable.CustomRatingBar_numStars, 5);
            mRating = typedArray.getFloat(R.styleable.CustomRatingBar_rating, 0f);
            mRatingViewClassName = typedArray.getString(R.styleable.CustomRatingBar_ratingViewClass);
            if(TextUtils.isEmpty(mRatingViewClassName)){
                mRatingViewClassName = "com.peter.guardianangel.view.starRatingBar.SimpleRatingView";
            }
        }
        try {
            mIRatingViews.clear();
